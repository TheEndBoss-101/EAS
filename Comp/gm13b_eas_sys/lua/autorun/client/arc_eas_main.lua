...
function EAS_MakeMessage()
    if EAS_DATA_FIPS_Codes_SS_County_CCC_ID == "000" then
        Same_Message_PSSCCC =
            EAS_DATA_FIPS_SubDiv_P ..
            " " .. EAS_DATA_FIPS_Codes_SS_Name .. ", " .. EAS_DATA_FIPS_Codes_SS_County_CCC_Name .. ""
    else
    ...
    http.Fetch(
        ...
        function(body, length, headers, code)
            ...
            if ReturnedHTML == LastReturnedHTML and check == true then
                ...
                local EAS_XML_SAME_HEADER =
                    EAS_XML_Org ..
                    "-" .. EAS_XML_Event .. "-" .. EAS_XML_PSSCCC_Full .. "-" .. EAS_XML_HHMM .. "-" .. EAS_XML_LLLLLLLL
                ...
                if EAS_DATA_Events_EEE_Level == "TEST" then
                    chat.AddText(
                        ...
                        "TEST: ",
                        Color(150, 255, 255),
                        "THIS IS A TEST OF THE EAS SYSTEM AND IS ONLY A TEST.",
                        "\n"
                    )
                end
